...
//				browser	
				...
				case"edge":cb.setBrowserName("MicrosoftEdge");break;
				default: System.out.println("no matching browser");return;
				}
				driver=new RemoteWebDriver(new URL("http://localhost:4444/wd/hub"),cb);	
			}
...
//			 driver.quit();
		 ...
		 public String captureScreen(String Name) throws IOException {
			    String timeStamp = new SimpleDateFormat("yyyyy%ddhhmmss").format(new Date());
